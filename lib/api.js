...
var BASE_URL = 'http://localhost:3232';
...
API.prototype.validateKeyDerivation = function(opts, cb) {
  ...
  function testHardcodedKeys() {
    ...
    if (xpriv.toString() != 'XPARHAr37YxmFP8wykidyYQfjTNAowHDjeZKFVm35RJWZvrfxdkMujNA4sss2nQpKSMzgY51shRF5esBh4YcvfoNw2U5nRgNzppAn59ujQdaBzgU') return false;

    xpriv = xpriv.deriveChild("m/44'/44'/0'");
    if (xpriv.toString() != 'XPARHAwruqjZzkJTyDjLk2ekPxmTWPhHQahoDUZndMyMdSQVatDm3q64fW4o7vP85en7nXEbcq7awrmLKunY3ZU9MKayKqt4b5fqGUFYpVh3gd8h') return false;
